...
function About() {
 return (
    <div className="about-container">
            ...
            <h6 className="tldr"> TL:DR I own a Small Women's Apparel Brand, recently graduated from a Full-Stack Web Bootcamp and currently work as an associate at Snow Peak's Warehouse. I like to create digital product experiences that inspire people towards positive action. </h6>
            <br/>
            <p>
